    ...
    >
      <div className="container mx-auto px-4">
        ...
        >
          ...
          >
            Hire Next.js Developer Pricing & Packages
          </h2>
            ...
            <motion.div
              ...
              className={`relative rounded-3xl p-6 sm:p-8 transition-all duration-300 ${
                plan.popular
                  ...
                  : 'bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 border-2 border-gray-200 dark:border-gray-700 hover:border-indigo-400 dark:hover:border-indigo-600 hover:shadow-2xl active:scale-95'
              }`}
            >
              {/* Popular Badge */}
              {plan.popular && (
