  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <div className="bg-gradient-to-r from-purple-600 to-indigo-700 rounded-2xl p-4 shadow-2xl border border-purple-500/20">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-white font-semibold text-sm">Performance Max</div>
                  <div className="text-purple-100 text-xs">6.5× ROAS Guarantee</div>
                </div>
              </div>
              <button
            ...
            <div className="flex gap-2">
              <Link
                ...
                className="flex-1 bg-white text-purple-600 px-4 py-3 rounded-xl font-semibold text-sm text-center hover:bg-purple-50 transition-colors"
              >
                Call Now
              </Link>
              <Link
