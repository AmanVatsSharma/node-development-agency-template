  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <div className="bg-gradient-to-r from-yellow-600 to-orange-700 rounded-2xl p-4 shadow-2xl border border-yellow-500/20">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-white font-semibold text-sm">Landing Page Optimization</div>
                  <div className="text-yellow-100 text-xs">3.5× Conversion Rate Guarantee</div>
                </div>
              </div>
              <button
            ...
            <div className="flex gap-2">
              <Link
                ...
                className="flex-1 bg-white text-yellow-600 px-4 py-3 rounded-xl font-semibold text-sm text-center hover:bg-yellow-50 transition-colors"
              >
                Call Now
              </Link>
              <Link
