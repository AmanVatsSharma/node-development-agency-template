  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <div className="bg-gradient-to-r from-teal-600 to-cyan-700 rounded-2xl p-4 shadow-2xl border border-teal-500/20">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-white font-semibold text-sm">Google Ads Audit</div>
                  <div className="text-teal-100 text-xs">40%+ Improvement Guarantee</div>
                </div>
              </div>
              <button
            ...
            <div className="flex gap-2">
              <Link
                ...
                className="flex-1 bg-white text-teal-600 px-4 py-3 rounded-xl font-semibold text-sm text-center hover:bg-teal-50 transition-colors"
              >
                Call Now
              </Link>
              <Link
