  ...
  sections: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          link: "/pages/nodejs-development",
          description: "Scalable Node.js backends & APIs",
          icon: "🟢",
          iconKey: "nodejs",
        },
        {
        ...
        {
          name: "Delhi Web Development",
          link: "/pages/web-development-delhi",
          description: "Web development for Delhi NCR businesses",
          icon: "🏙️",
          iconKey: "city",
          badge: "Delhi",
        },
        {
          name: "Bangalore Web Development",
          link: "/pages/web-development-bangalore",
          description: "Web development for Bangalore startups",
          icon: "🏙️",
          iconKey: "city",
          badge: "Bangalore",
        },
        {
          name: "Gurgaon Web Development",
          link: "/pages/web-development-gurgaon",
          description: "Gurgaon-based web development",
          icon: "🏙️",
          iconKey: "city",
          badge: "Gurgaon",
        },
