...
export function FinalCTASection() {
  const handleCTAClick = (ctaType: string) => {
    console.log(`[YouTube-Final-CTA] CTA clicked: ${ctaType}`);
    if (typeof window !== 'undefined' && (window as any).gtag) {
      (window as any).gtag('event', 'youtube_final_cta_click', {
        cta_type: ctaType,
  ...
  return (
    <section className="py-16 md:py-20 bg-gradient-to-br from-red-900 via-pink-900 to-purple-900 relative overflow-hidden">
      {/* Background Elements */}
        ...
        <div className="text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Join 180+ YouTube marketers who trust us with their advertising. 
              Get specialized support, video strategies, and guaranteed 6.2× ROAS.
            </p>
          </motion.div>
          ...
          >
            ...
            <Link
              href="mailto:youtube@rajapragyabharat.com"
          ...
          >
            <h3 className="text-2xl font-bold text-white mb-4">
              YouTube Advertising Process
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
              <div className="flex flex-col items-center">
                <div className="w-12 h-12 bg-red-500 rounded-full flex items-center justify-center text-white font-bold text-lg mb-3">1</div>
                <h4 className="text-white font-semibold mb-2">Video Strategy</h4>
                <p className="text-gray-300 text-sm">Comprehensive analysis of your YouTube presence, competitors, and current video performance</p>
              </div>
              <div className="flex flex-col items-center">
                <div className="w-12 h-12 bg-pink-500 rounded-full flex items-center justify-center text-white font-bold text-lg mb-3">2</div>
                <h4 className="text-white font-semibold mb-2">Video Production</h4>
                <p className="text-gray-300 text-sm">Professional video ad creation and optimization designed for maximum engagement and conversions</p>
              </div>
              <div className="flex flex-col items-center">
                ...
                <h4 className="text-white font-semibold mb-2">Campaign Launch</h4>
                <p className="text-gray-300 text-sm">Full campaign implementation with 30-day guarantee and ongoing video optimization</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <p className="text-gray-300 text-sm">
              <strong>Limited Time:</strong> First 20 YouTube clients get 25% off their first 3 months + free video production
            </p>
