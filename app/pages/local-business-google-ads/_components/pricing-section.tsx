...
export function PricingSection() {
  const handleCTAClick = (plan: string) => {
    console.log(`[Local-Business-Pricing] CTA clicked: ${plan}`);
    if (typeof window !== 'undefined' && (window as any).gtag) {
      (window as any).gtag('event', 'local_business_pricing_cta_click', {
        plan: plan,
  ...
  const plans = [
    ...
    },
    {
      ...
      price: "₹75K+",
      period: "/month",
      description: "For large local operations",
      features: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="text-gray-600 mb-4">
            All plans include our 5.8× ROAS guarantee and 30-day money-back guarantee.
          </p>
