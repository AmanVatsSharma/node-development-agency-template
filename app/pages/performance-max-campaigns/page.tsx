...
export default function PerformanceMaxCampaignsPage() {
  useEffect(() => {
    ...
    return () => {
      console.log('[Performance-Max] Page unmounted');
    };
  }, []);
  ...
  return (
    <main className="min-h-screen">
      ...
      <div className="container mx-auto px-4 pt-8">
        <Breadcrumbs items={getBreadcrumbItems('performance-max-campaigns')} />
      </div>
      ...
      <SectionErrorBoundary name="RelatedServices">
        <RelatedServices 
          currentPage="performance-max-campaigns"
          title={getRelatedServicesTitle('performance-max-campaigns')}
        />
      </SectionErrorBoundary>
