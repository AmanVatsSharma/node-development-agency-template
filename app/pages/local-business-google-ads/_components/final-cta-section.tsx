...
export function FinalCTASection() {
  const handleCTAClick = (ctaType: string) => {
    console.log(`[Local-Business-Final-CTA] CTA clicked: ${ctaType}`);
    if (typeof window !== 'undefined' && (window as any).gtag) {
      (window as any).gtag('event', 'local_business_final_cta_click', {
        cta_type: ctaType,
        ...
        <div className="text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Join 200+ local businesses who trust us with their Google Ads. 
              Get specialized support, local strategies, and guaranteed 5.8× ROAS.
            </p>
          </motion.div>
          ...
          >
            ...
            >
              ...
              Call Local Business Team
              <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </Link>

            <Link
              href="mailto:local@rajapragyabharat.com"
          ...
          >
            <h3 className="text-2xl font-bold text-white mb-4">
              Local Business Consultation Process
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
              <div className="flex flex-col items-center">
                ...
                <h4 className="text-white font-semibold mb-2">Local Market Analysis</h4>
                <p className="text-gray-300 text-sm">Comprehensive analysis of your local market, competitors, and current Google Ads performance</p>
              </div>
              <div className="flex flex-col items-center">
                ...
                <h4 className="text-white font-semibold mb-2">Local Strategy</h4>
                <p className="text-gray-300 text-sm">Tailored local business strategy designed for your specific market and customer base</p>
              </div>
              <div className="flex flex-col items-center">
                ...
                <p className="text-gray-300 text-sm">Full implementation with 30-day guarantee and ongoing local market optimization</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <p className="text-gray-300 text-sm">
              <strong>Limited Time:</strong> First 25 local businesses get 30% off their first 3 months + free Google My Business setup
            </p>
