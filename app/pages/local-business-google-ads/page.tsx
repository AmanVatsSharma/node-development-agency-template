  ...
  return (
    <main className="min-h-screen">
      ...
      <div className="container mx-auto px-4 pt-8">
        <Breadcrumbs items={getBreadcrumbItems('local-business-google-ads')} />
      </div>
      ...
      <SectionErrorBoundary name="RelatedServices">
        <RelatedServices 
          currentPage="local-business-google-ads"
          title={getRelatedServicesTitle('local-business-google-ads')}
        />
      </SectionErrorBoundary>
