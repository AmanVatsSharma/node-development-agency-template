  ...
  return (
    <main className="min-h-screen">
      ...
      <div className="container mx-auto px-4 pt-8">
        <Breadcrumbs items={getBreadcrumbItems('youtube-advertising-management')} />
      </div>
      ...
      <SectionErrorBoundary name="RelatedServices">
        <RelatedServices 
          currentPage="youtube-advertising-management"
          title={getRelatedServicesTitle('youtube-advertising-management')}
        />
      </SectionErrorBoundary>
