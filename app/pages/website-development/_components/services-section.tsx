...
export function ServicesSection() {
  useEffect(() => {
    console.log('[Website-Development] ServicesSection mounted');
    return () => console.log('[Website-Development] ServicesSection unmounted');
  }, []);
  ...
  return (
    <section 
      ...
      role="region" aria-labelledby="wd-services-heading"
    >
      {/* Background pattern */}
