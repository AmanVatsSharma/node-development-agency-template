...
const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    title: "ShopWave — Headless commerce platform handling 50K+ daily orders",
    client: "D2C Retail Brand",
    industry: "E-commerce · India",
    summary: "Replatformed a legacy Magento storefront onto a headless Shopify Hydrogen + Next.js stack, cutting page-load times and lifting conversion rates within a single quarter.",
    detail: "The brand was bleeding conversions to slow page loads during peak sale windows. We migrated to Shopify's Storefront API with a custom Next.js frontend, edge-cached the catalog in 12 regions, and integrated their existing ERP for inventory sync. Peak-sale traffic that previously buckled the old stack now scales linearly with zero downtime.",
    metrics: [
      { value: "3.2×", label: "Conversion Uplift" },
      { value: "0.8s", label: "Median LCP" },
      { value: "100%", label: "Peak-Sale Uptime" },
    ],
    tags: ["Shopify", "Next.js", "Hydrogen", "Edge Cache"],
    accentColor: "#059669",
  },
  {
    id: "logistics-ai",
