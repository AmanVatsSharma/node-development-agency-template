...
export function PricingSection() {
  const handleCTAClick = (plan: string) => {
    console.log(`[B2B-Pricing] CTA clicked: ${plan}`);
    if (typeof window !== 'undefined' && (window as any).gtag) {
      (window as any).gtag('event', 'b2b_pricing_cta_click', {
        plan: plan,
  ...
  const plans = [
    {
      ...
      price: "₹60K",
      period: "/month",
      description: "Perfect for small to medium B2B businesses",
      features: [
        "B2B Audience Targeting",
        "Lead Qualification System",
        "Up to ₹8L monthly ad spend",
    ...
    },
    {
      ...
      features: [
        ...
        "Up to ₹20L monthly ad spend",
        "Advanced Lead Nurturing",
        "Custom Audience Segments",
        "Daily Lead Optimization",
        "Priority Support",
        "Competitor Analysis",
    ...
    },
    {
      ...
      price: "₹1.25L+",
      period: "/month",
      description: "For large B2B operations",
      features: [
        "Everything in Professional",
        "Unlimited ad spend",
        "Dedicated B2B Team",
        "Custom Lead Strategies",
        "Advanced Automation",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
            Hire B2B Lead Generation Expert Pricing & Packages
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Choose the perfect B2B lead generation plan for your business. All plans include our 7.2× ROAS guarantee.
          </p>
        </motion.div>
          ...
          {plans.map((plan, index) => (
            <motion.div
              ...
              className={`relative p-8 rounded-2xl ${
                plan.popular
                  ? 'bg-gradient-to-br from-green-600 to-emerald-700 text-white shadow-2xl scale-105'
            ...
            >
              ...
              <div className="text-center mb-8">
                ...
                <div className="flex items-baseline justify-center">
                  ...
                  <span className={`text-lg ${plan.popular ? 'text-green-100' : 'text-gray-600'}`}>
                    {plan.period}
                  </span>
                </div>
              </div>
        ...
        >
          <p className="text-gray-600 mb-4">
            All plans include our 7.2× ROAS guarantee and 30-day money-back guarantee.
          </p>
