                ...
                <ul className="space-y-3">
                  {section.items.map((item, itemIdx) => (
                    <li key={itemIdx}>
                      ...
                      >
                        <ServiceIcon iconKey={item.iconKey as ServiceIconKey | undefined} emoji={item.icon} size={22} className="text-blue-600 dark:text-blue-400 flex-shrink-0 group-hover:scale-110 transition-transform" />
...
export default function EnhancedHeader() {
  ...
  return (
    <div className="relative w-full">
      ...
      <Navbar className="pt-2.5 sm:pt-4">
        <MobileNav>
          <MobileNavHeader>
            {/* Mobile Logo */}
            <NavbarLogo
