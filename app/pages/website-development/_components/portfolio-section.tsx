    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden rounded-xl">
        <Image
          ...
          onError={(e) => {
            console.error('[Website-Development] Portfolio image failed', { id: item.id, src: item.imageUrl });
          }}
          priority={index < 2}
        />
...
export function PortfolioSection() {
  ...
  return (
    <section className="py-20 relative overflow-hidden" id="portfolio" role="region" aria-labelledby="wd-portfolio-heading">
