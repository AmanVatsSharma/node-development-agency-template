...
export const metadata: Metadata = buildPageMetadata({
  title: 'Landing Page Optimization & CRO India | A/B Testing — Vedpragya',
  description: 'Increase your landing page conversion rate with data-driven CRO: A/B testing, heatmaps, copy rewrites, and UX fixes. India-based CRO agency. Free page audit.',
  ...
  return (
    <main className="min-h-screen">
      ...
      <SectionErrorBoundary name="ROICalculator">
        <div className="py-16 md:py-20 bg-gradient-to-br from-gray-50 to-teal-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <ROICalculator industry="Landing Page" />
          </div>
        </div>
      </SectionErrorBoundary>
      ...
      <SectionErrorBoundary name="ServiceNavigation">
        <div className="py-16 md:py-20 bg-gradient-to-br from-teal-50 to-cyan-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <ServiceNavigation 
              currentService="landing-page-optimization"
