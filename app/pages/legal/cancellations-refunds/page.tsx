...
export const metadata: Metadata = buildPageMetadata({
  title: "Cancellations & Refunds Policy | Vedpragya Bharat Private Limited",
  description:
    "Cancellations and Refunds Policy for Vedpragya Bharat Private Limited. Comprehensive refund terms for software development and digital services.",
  ...
  keywords: [
    ...
    "service refunds",
    "Vedpragya Bharat",
    "vedpragya refund policy",
    "software development refund terms",
  ],
});
