...
import { ShoppingCart, TrendingUp, Target, Zap, Star, ArrowRight, Play } from 'lucide-react';
import Link from 'next/link';

export function HeroSection() {
  const handleCTAClick = (ctaType: string) => {
    console.log(`[Ecommerce-Hero] CTA clicked: ${ctaType}`);
    if (typeof window !== 'undefined' && (window as any).gtag) {
      (window as any).gtag('event', 'ecommerce_hero_cta_click', {
        cta_type: ctaType,
  ...
  const handleVideoPlay = () => {
    console.log('[Ecommerce-Hero] Video play clicked');
    if (typeof window !== 'undefined' && (window as any).gtag) {
      (window as any).gtag('event', 'video_play', {
        video_title: 'E-commerce Google Ads Success Story',
        page_location: window.location.pathname
      });
    }
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            >
              ...
              <span className="text-orange-300 text-sm font-medium">E-commerce Google Ads Optimization</span>
            ...
            >
              Transform your e-commerce store with expert Google Shopping campaigns, 
              product feed optimization, and conversion tracking that delivers 
              <span className="text-cyan-400 font-semibold"> 6.8× ROAS</span> and 
              <span className="text-cyan-400 font-semibold"> 45% more sales</span>.
            </motion.p>
            ...
            >
              {[
                { icon: ShoppingCart, text: "Shopping Campaigns", metric: "6.8× ROAS" },
                { icon: Target, text: "Product Feed Optimization", metric: "45% More Sales" },
                { icon: TrendingUp, text: "Conversion Tracking", metric: "98% Accuracy" }
              ].map((feature, index) => (
            ...
            >
              ...
              <div className="text-gray-300">
                <span className="font-bold text-cyan-400">200+</span> E-commerce Stores Optimized
              </div>
              <div className="text-gray-300">
                <span className="font-bold text-cyan-400">₹2.5Cr+</span> Revenue Generated
              </div>
            </motion.div>
          </div>
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="text-white text-sm font-medium">Google Ads Dashboard</div>
              </div>
              ...
              <div className="space-y-4">
                <div className="bg-gradient-to-r from-cyan-500/20 to-blue-500/20 rounded-lg p-4 border border-cyan-500/30">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-cyan-300 text-sm font-medium">Shopping Campaigns</span>
                    <span className="text-green-400 text-sm font-bold">+45%</span>
                  </div>
                  <div className="text-white text-2xl font-bold">₹2.5L Revenue</div>
                  <div className="text-gray-300 text-sm">Last 30 days</div>
                </div>

                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-white/5 rounded-lg p-3">
                    <div className="text-cyan-400 text-sm font-medium">ROAS</div>
                    <div className="text-white text-xl font-bold">6.8×</div>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3">
                    <div className="text-cyan-400 text-sm font-medium">CTR</div>
                ...
                <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-lg p-4 border border-purple-500/30">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-purple-300 text-sm font-medium">Product Feed</span>
                    <span className="text-green-400 text-sm font-bold">Optimized</span>
                  </div>
                  <div className="text-white text-lg font-bold">2,500+ Products</div>
