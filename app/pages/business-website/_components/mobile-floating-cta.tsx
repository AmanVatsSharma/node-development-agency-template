              ...
              {isExpanded && (
                ...
                >
                  ...
                  <motion.a
                    ...
                    onClick={() => { console.log('[Business-Website] Mobile floating phone clicked'); void fireConversion('call_click', 'business-website'); }}
                  >
                  ...
                  <motion.a
                    ...
                    onClick={() => { console.log('[Business-Website] Mobile floating WhatsApp clicked'); void fireConversion('whatsapp_click', 'business-website'); }}
                  >
