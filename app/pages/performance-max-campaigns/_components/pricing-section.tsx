...
export function PricingSection() {
  const handleCTAClick = (plan: string) => {
    console.log(`[Performance-Max-Pricing] CTA clicked: ${plan}`);
    if (typeof window !== 'undefined' && (window as any).gtag) {
      (window as any).gtag('event', 'performance_max_pricing_cta_click', {
        plan: plan,
  ...
  const plans = [
    {
      name: "Performance Max Starter",
      price: "₹40K",
      period: "/month",
      description: "Perfect for small businesses starting with Performance Max",
      features: [
        "Basic Performance Max Setup",
        "Cross-Network Optimization",
        "Up to ₹6L monthly ad spend",
      ...
      cta: "Start Performance Max Plan",
      popular: false
    },
    {
      name: "Performance Max Professional",
      price: "₹70K",
      period: "/month",
      description: "For growing businesses with Performance Max needs",
      features: [
        "Everything in Starter",
        "Up to ₹15L monthly ad spend",
        "Advanced Automation",
    ...
    {
      name: "Performance Max Enterprise",
      price: "₹90K+",
      period: "/month",
      description: "For large businesses with extensive Performance Max needs",
      features: [
        "Everything in Professional",
        "Unlimited ad spend",
        "Dedicated Performance Max Team",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {plans.map((plan, index) => (
            <motion.div
              ...
              className={`relative p-8 rounded-2xl ${
                plan.popular
                  ? 'bg-gradient-to-br from-purple-600 to-indigo-700 text-white shadow-2xl scale-105'
                ...
                {plan.features.map((feature, featureIndex) => (
                  <li key={featureIndex} className="flex items-start gap-3">
                    <Check className={`w-5 h-5 mt-0.5 flex-shrink-0 ${
                      plan.popular ? 'text-green-400' : 'text-purple-600'
                    }`} />
        ...
        >
          <p className="text-gray-600 mb-4">
            All plans include our 6.5× ROAS guarantee and 30-day money-back guarantee.
          </p>
