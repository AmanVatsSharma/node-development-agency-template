  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <div className="bg-gradient-to-r from-green-600 to-emerald-700 rounded-2xl p-4 shadow-2xl border border-green-500/20">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-white font-semibold text-sm">B2B Lead Generation</div>
                  <div className="text-green-100 text-xs">7.2× ROAS Guarantee</div>
                </div>
              </div>
              <button
            ...
            <div className="flex gap-2">
              <Link
                ...
                className="flex-1 bg-white text-green-600 px-4 py-3 rounded-xl font-semibold text-sm text-center hover:bg-green-50 transition-colors"
              >
                Call Now
              </Link>
              <Link
