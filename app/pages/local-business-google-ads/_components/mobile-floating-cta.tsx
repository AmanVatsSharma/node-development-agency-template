  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl p-4 shadow-2xl border border-blue-500/20">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-white font-semibold text-sm">Local Business Google Ads</div>
                  <div className="text-blue-100 text-xs">5.8× ROAS Guarantee</div>
                </div>
              </div>
              <button
            ...
            <div className="flex gap-2">
              <Link
                ...
                className="flex-1 bg-white text-blue-600 px-4 py-3 rounded-xl font-semibold text-sm text-center hover:bg-blue-50 transition-colors"
              >
                Call Now
              </Link>
              <Link
