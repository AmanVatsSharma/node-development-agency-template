...
- **2025-03-08**: Sitemap fixes: hardcoded fallback in constants.ts set to vedpragya.com; Meta.tsx uses SEO_SITE_URL and companyProfile; ALL_STATIC_PAGE_ROUTES added so sitemap includes every static page even if filesystem discovery fails.
