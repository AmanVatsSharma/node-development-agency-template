...
const products = [
  ...
  {
    name: "ShopWave",
    tag: "Headless E-Commerce Platform",
    desc: "Headless Shopify commerce stack handling 50,000+ daily orders with edge-cached catalog and sub-second page loads across 12 regions.",
    metrics: [
      { val: "3.2×", label: "Conversion uplift" },
      { val: "0.8s", label: "Median LCP" },
      { val: "100%", label: "Peak-sale uptime" },
    ],
