        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-gray-400 mb-4">
              Premium Node.js development and 3D experiences for enterprise clients. Elevating businesses with cutting-edge technology solutions.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-400">info@enterprisehero.com</span>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              &copy; {currentYear} EnterpriseHero. All rights reserved.
            </p>
