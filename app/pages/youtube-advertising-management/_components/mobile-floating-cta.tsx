  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <div className="bg-gradient-to-r from-red-600 to-pink-700 rounded-2xl p-4 shadow-2xl border border-red-500/20">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-white font-semibold text-sm">YouTube Advertising</div>
                  <div className="text-red-100 text-xs">6.2× ROAS Guarantee</div>
                </div>
              </div>
              <button
