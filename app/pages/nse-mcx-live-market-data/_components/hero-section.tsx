...
export function HeroSection() {
  ...
  return (
    ...
    >
      <HeroHighlight 
        containerClassName="min-h-screen pt-36 sm:pt-40 md:pt-44 lg:pt-36"
      ...
      >
        ...
        <div className="absolute left-0 right-0 bg-black/40 backdrop-blur-md border-y border-[#00FF88]/30 py-3 overflow-hidden z-20 top-36 sm:top-36 md:top-24 lg:top-20">
          <motion.div
            animate={{ x: [0, -1000] }}
        ...
        <div className="container mx-auto px-4 pt-40 pb-14 sm:pt-44 sm:pb-16 md:pt-48 md:pb-20 lg:pt-48 lg:pb-24 relative z-10">
